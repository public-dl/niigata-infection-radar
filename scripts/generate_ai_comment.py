...
- 数値と単位の間には必ず半角スペースを1つ入れる。
- 単位の区切りには半角スラッシュ「/」を使う。
- 「人／定点」は使用せず、必ず「人/定点」とする。
- 「6.13」「3.58」「13.0」のように、定点当たり報告数を無単位で書かない。
- 正しい表記例：「6.13 人/定点」「3.58 人/定点」「13.0 人/定点」「0.27 人/定点」。
- 「6.13人／定点」「6.13人/定点」「6.13 人／定点」のような表記は使用しない。

- 前週からの変化は、割合（％）ではなく定点当たり報告数の絶対差で表現する。
- 「前週比71.2％増加」「71.2％増」のような割合表現は使用しない。
- 例：最新6.13 人/定点、前週3.58 人/定点の場合は
  「前週から2.55 人/定点増加」と表現する。
- 減少の場合も「前週から0.80 人/定点減少」のように表現する。
